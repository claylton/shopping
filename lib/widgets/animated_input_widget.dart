...
class AnimatedInputWidget extends StatelessWidget {
  ...
  AnimatedInputWidget({required this.controller, super.key})
  ...
  Widget _animate(BuildContext context, Widget? child) {
    return Container(
      height: 60,
      decoration: BoxDecoration(
        color: containerColorAnim.value,
        borderRadius: BorderRadius.circular(containerBorderRadiusAnim.value),
      ),
